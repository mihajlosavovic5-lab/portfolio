    ...
    const translations = {
        en: {
            ...
            bio: "I'm a 20-year-old frontend developer from Serbia, currently studying at the Faculty of Information Technology at CTU in Prague. I graduated from an IT high school and have been building websites for the past 3 years.<br><br>I focus on frontend because I love turning ideas into clean, interactive experiences — things that look good and feel smooth to use.<br><br>I'm open to freelance work and collaborations. If you have a project in mind, feel free to reach out.",
        ...
        sr: {
            ...
            bio: 'Imam 20 godina i frontend developer sam iz Srbije, trenutno studiram na Fakultetu informacionih tehnologija ČVUT u Pragu. Završio sam IT srednju školu i pravim sajtove već 3 godine.<br><br>Fokusiran sam na frontend jer volim da pretvorim ideje u čista, interaktivna iskustva — stvari koje izgledaju dobro i lepo se koriste.<br><br>Otvoren sam za freelance rad i saradnje. Ako imaš projekat na umu, slobodno se javi.',
